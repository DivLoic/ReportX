...
\caption{Possibilité de choisir une industrie et faire la différence par rapport à la moyenne de son industrie}
\end{figure}
\end{center}
...
\begin{itemize}
\item[-]
\item[-]\link{ftp.ncdc.noaa.gov/pub/data/gsod/readme.txt}{ftp.ncdc.noaa.gov/pub/data/gsod/readme.txt} permet de comprendre les données, les unités, les différentes colonnes, le lien entre les fichiers etc.
\item[-]\link{ftp.ncdc.noaa.gov/pub/data/noaa/isd-history.csv}{ftp.ncdc.noaa.gov/pub/data/noaa/isd-history.csv} liste les stations météorologiques disponibles.
\item[-]\link{ftp.ncdc.noaa.gov/pub/data/gsod/2012/}{ftp.ncdc.noaa.gov/pub/data/gsod/2012/} contient l’ensemble des données de l’année 2012 pour les différentes stations.
\end{itemize}
