...
\begin{figure}[h!]
\centering
\includegraphics[scale=1]{image/PandasCorp.png}
\end{figure}
\textit{Equipe Pandas}
\end{center}
...
\input{./sections/conclusion.Rnw}

\appendix

\input{./sections/appendix.Rnw}
